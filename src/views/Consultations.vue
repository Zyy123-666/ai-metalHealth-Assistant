    ...
    <div>
        ...
        <el-table :data="tableData" style="width: 100%;">
            ...
            <el-table-column label="操作" width="200">
                <template #default="scope">
                    <el-button type="primary" text size="mini" @click="viewSessionDetail(scope.row)">详情</el-button>
                </template>
            </el-table-column>
        </el-table>
        <el-pagination style="margin-top: 25px;" v-model:current-page="pagination.currentPage"
            ...
            @change="handleChange" />
        <el-dialog v-model="showDetailDialog" title="咨询对话详情" width="70%" :close-on-click-modal="false">
            <div class="session-detail">
                <div class="detail-header">
                    <div class="detail-row">
                        <div class="detail-lable">用户：</div>
                ...
                <div class="detail-header">
                    <div class="detail-row">
                        <div class="detail-lable">开始时间：</div>
                ...
                <div class="detail-header">
                    <div class="detail-row">
                        <div class="detail-lable">消息数：</div>
