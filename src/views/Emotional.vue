...
const handleSearch = async (formData) => {
    ...
    // console.log(getEmotionalPage(params));
...
<template>
    <div>
        ...
        <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column label="操作" width="160" fixed="right" align="left" header-align="left"
        ...
        <el-pagination style="margin-top: 25px;" v-model:current-page="pagination.current" :page-size="pagination.size"
            :total="pagination.total" layout="total, prev, pager, next, jumper" @change="handleChange" />

        <el-dialog v-model="detailDialogVisible" title="情绪日志详情" width="800px" :close-on-click-modal="false"
            class="detail-content" top="2vh">
            <div v-if="currentDetail">
                ...
                <div class="detail-section">
                    ...
                    <el-descriptions :column="2" border>
                        ...
                        <el-descriptions-item label="主要情绪">
                            <el-tag :type="getAiEmotionTagType(currentDetail.dominantEmotion)">{{
                ...
                <div class="detail-section">
                    <h4>AI情绪分析结果</h4>
                    <div class="ai-analysis-result" v-if="aiData">
                        <el-descriptions :column="2" border>
                            <el-descriptions-item label="主要情绪">
