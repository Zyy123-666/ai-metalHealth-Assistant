...
<template>
    <div class="dashboard-container">
        <!-- 四个图标 -->
        <el-row :gutter="20" v-if="aiData?.systemOverview">
            <el-col :span="6">
                <el-card>
                ...
                <el-card>
                    <div class="card-content">
                        ...
                        <div class="info">
                            ...
                            <p class="subtitle-title">今日新增：{{ aiData.systemOverview.todayNewDiaries
                            }}</p>
                        </div>
                    </div>
                </el-card>
                ...
                <el-card>
                    <div class="card-content">
                        ...
                        <div class="info">
                            ...
                            <p class="subtitle-title">今日新增：{{ aiData.systemOverview.todayNewSessions
                            }}</p>
                        </div>
                    </div>
                </el-card>
        ...
        <!-- echarts图 -->
        <el-row style="margin-top: 20px;" :gutter="20" class="dashboard-echarts-row">
            <!-- 图1 -->
            <el-col :span="12">
